...
class ConfirmationModule:
    ...
    def _fetch_data(self):
        ...
        self.data['Volume_RRatio'] = self.data['Volume'] / self.data['Volume_SMA']
    ...
    def _check_bullish_entry(self, setup_results):
        ...
        if latest['Volume_RRatio'] > 1.5:
            reasons.append(f"Volume spike ({latest['Volume_RRatio']:.2f}x average)")
            signal_strength += 20
